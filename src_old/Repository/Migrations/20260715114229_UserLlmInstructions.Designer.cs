...
namespace Repository.Migrations
{
    ...
    [Migration("20260715114229_UserLlmInstructions")]
    partial class UserLlmInstructions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Domain.Entities.ImageConversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("ImageConversations");
                });

            modelBuilder.Entity("Core.Domain.Entities.ImagePrompt", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ImagePrompts");
                });

            modelBuilder.Entity("Core.Domain.Entities.ImagePromptFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ImagePromptId")
                        .IsUnique();

                    b.ToTable("ImagePromptFiles");
                });
            ...
            modelBuilder.Entity("Core.Domain.Entities.PostAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<Guid>("UserUploadedFileId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Core.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<string>("UserLlmInstuctions")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Core.Domain.Entities.UserUploadedFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Core.Domain.Entities.ImagePrompt", b =>
                {
                    b.HasOne("Core.Domain.Entities.ImageConversation", "Conversation")
                        .WithMany("ImagePrompts")
            ...
            modelBuilder.Entity("Core.Domain.Entities.ImagePromptFile", b =>
                {
                    b.HasOne("Core.Domain.Entities.ImagePrompt", "ImagePrompt")
                        .WithOne("ImagePromptFile")
                        .HasForeignKey("Core.Domain.Entities.ImagePromptFile", "ImagePromptId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Core.Domain.Entities.PostAttachment", b =>
                {
                    ...
                    b.HasOne("Core.Domain.Entities.UserUploadedFile", "File")
                        .WithMany("PostAttachments")
                        .HasForeignKey("UserUploadedFileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Core.Domain.Entities.ImageConversation", b =>
                {
                    b.Navigation("ImagePrompts");
                });

            modelBuilder.Entity("Core.Domain.Entities.ImagePrompt", b =>
                {
                    b.Navigation("ImagePromptFile");
                });
            ...
            modelBuilder.Entity("Core.Domain.Entities.User", b =>
                {
                    b.Navigation("ImageConversations");
